...
class DetailsRoom:
    def __init__(self, root):
        ...
        lbl_roomNo = Label(labelframeleft, font=(
            "arial", 12, "bold"), text="Room No: ", padx=2, pady=6)
        ...
        # self.var_Roomtype = StringVar()  # Corrected variable name

        # entry_RoomType = ttk.Entry(
        #     labelframeleft, textvariable=self.var_Roomtype, font=("arial", 12, "bold"), width=20)  # Corrected variable name
        # entry_RoomType.grid(row=2, column=1, sticky=W)
        
        lbl_lbl_RoomType = Label(labelframeleft, font=("arial", 12, "bold"), text="Room Type: ", padx=2, pady=6)
        ...
        self.room_table.heading("roomno", text="Room No")  # Corrected column name
